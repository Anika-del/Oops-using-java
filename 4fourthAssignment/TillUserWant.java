//How can I write a program to enter numbers until the user wants? At the end, it should display the count of positive, negative, and zeros entered.

import java.util.Scanner; 
public class TillUserWant {
